...
denomstrate reverse mode AD for $f(x_1, x_2)$ taking $x_1=0.5$ and $x_2=1$.
...
our prior. Where the code implementing $U(\beta; \mathcal{D})$ is given as
...
For the sake of brevity we do not present the code exporting the gradient of $U$, noting it is essentially identical as in the previous example. Running our Markov chain for $10,000$ iterations we obtain posterior samples for $\beta_1$ and $\beta_2$. We present the joint and marginal density is Figure 3.
